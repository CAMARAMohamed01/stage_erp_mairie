    ...
    <form action="{{ route('contrats.update', $contrat->id_contrat) }}" method="POST" class="space-y-8">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-slate-700 mb-1">Tiers (Prestataire /
                        Fournisseur) *</label>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
                    ...
                    <label for="revision_prix_prevue" class="text-sm font-medium text-slate-700 cursor-pointer">Révision
                        des prix prévue au contrat</label>
                </div>
            </div>
        </div>

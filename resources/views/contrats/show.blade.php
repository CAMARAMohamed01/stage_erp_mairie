    ...
    <div class="max-w-6xl mx-auto space-y-6 pb-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                @if(
                        str_contains(strtolower($contrat->type_contrat), 'maintenance') ||
                            ...
                            @forelse($interventionsTriggered as $int)
                                <div class="p-4 flex justify-between items-center text-xs hover:bg-slate-50 transition font-medium">
                                    ...
                                    <div class="text-right flex-shrink-0 ml-4">
                                        <span
                                            class="px-2 py-0.5 rounded-full font-bold bg-slate-100 border text
                                        -slate-600 text-[10px] uppercase">{{ $int->statut_global }}</span>

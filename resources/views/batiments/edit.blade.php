                ...
                <div>
                    ...
                    <select name="id_adresse" id="select_adresse" required
                        ...
                        <option value="{{ $adresse->id_adresse }}"
                            {{ $adresse->id_adresse == $batiment->id_adresse ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="id_parcelle" id="select_parcelle" required
                        ...
                        <option value="{{ $parcelle->id_parcelle }}"
                            {{ $parcelle->id_parcelle == $batiment->id_parcelle ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="md:col-span-1 relative">
                    ...
                    <select name="id_tiers" id="select_tiers" required
                        ...
                        <option value="">-- Sélectionner --</option>
                        @foreach($tiers as $t)
                        <option value="{{ $t->id_tiers }}" {{ $t->id_tiers == $batiment->id_tiers ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="id_type_erp" required class="w-full rounded-lg border-slate-300 text-sm bg-slate-50">
                        ...
                        <option value="{{ $erp->id_type_erp }}"
                            {{ $erp->id_type_erp == $batiment->id_type_erp ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="id_immo" id="select_immo" required
                        ...
                        <option value="{{ $immo->id_immo }}"
                            {{ $immo->id_immo == $batiment->id_immo ? 'selected' : '' }}>

            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="marque" placeholder="Ex: Atlantic, Husqvarna..."
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Couleur</label>
                        <input type="text" name="couleur" placeholder="Ex: Gris, Vert sapin, RAL 6005..."
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                    </div>
                    <div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="reference_serie" placeholder="Ex: SN-123456789"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="duree_garantie_mois" placeholder="Ex: 24"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                    </div>
                </div>
            </div>

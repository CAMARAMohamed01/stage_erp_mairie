...
@section('content')
    <div class="max-w-5xl mx-auto">
        ...
        @if(session('success'))
            <div class="mb-6 p-4 bg-green-50 text-green-800 font-bold rounded-xl border border-green-200 shadow-sm">
                {{ session('success') }}
            </div>
        @endif

        @if(session('error'))
            <div class="mb-6 p-4 bg-red-50 text-red-800 font-bold rounded-xl border border-red-200 shadow-sm">
                {{ session('error') }}
            </div>
        @endif
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                    ...
                    <div
                        ...
                        <div class="relative z-10">
                            <p class="font-extrabold text-indigo-950 text-base leading-tight">
                                {{ $intervention->projet->nom_projet }}
                            </p>
                        ...
                        <div class="pt-3 border-t border-slate-100">
                            ...
                            @if($intervention->troncon)
                                <p class="text-sm font-bold text-slate-800 mt-1">
                                    {{ $intervention->troncon->numero_troncon ?? 'Tronçon' }}
                                </p>
                ...
                <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                    ...
                    @if(
                            !($intervention->equipements && $intervention->equipements->count() > 0) && !$intervention->compteur
                                    ...
                                    <li
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[10px] font-medium text-slate-500 uppercase">
                                                {{ $agent->role_appli ?? 'Agent technique' }}
                                            </p>
                                        </div>
                                    </li>
                                @endforeach
                    ...
                    @if($intervention->demandeur)
                        <div class="mb-4">
                            ...
                            <p class="text-sm font-bold text-slate-800 mt-0.5">{{ $intervention->demandeur->prenom_user }}
                                {{ $intervention->demandeur->nom_user }}
                            </p>

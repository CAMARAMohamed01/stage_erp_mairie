...
class TiersController extends Controller
{
    ...
    {
        // On récupère uniquement les "Physiques", avec leurs infos et le compte de leurs signalements
    ...
    {
        // On charge le citoyen avec ses infos physiques et tous ses signalements (triés par date)
        $citoyen = Tiers::with([
            'physique',
            'signalements' => function ($query) {
